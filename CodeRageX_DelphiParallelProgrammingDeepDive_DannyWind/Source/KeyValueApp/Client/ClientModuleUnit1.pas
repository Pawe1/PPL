...
function TClientModule1.LastUpdate: TDateTime;
begin
  Result := ServerMethods1Client.LastUpdate;
end;

procedure TClientModule1.SyncValue(aKey: string; var aValue: string;
  var aDateTime: TDateTime);
begin
  ServerMethods1Client.SyncValue(aKey, aValue, aDateTime);
end;
